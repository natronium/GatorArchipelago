...
surface_item_table: List[GatorItemData] = [
    ...
    GatorItemData(
        ...
        1,
        [ItemGroup.Surface,ItemGroup.Traversal, ItemGroup.Surface,ItemGroup.Hat, ItemGroup.Surface,ItemGroup.Craft],
    ),
    GatorItemData(
        GatorItemName.STICK,
        100000028,
        ItemClassification.progression,
        1,
        [ItemGroup.Surface,ItemGroup.Cardboard_Destroyer, ItemGroup.Surface,ItemGroup.Item, ItemGroup.Surface,ItemGroup.Sword],
    ),
    GatorItemData(
        GatorItemName.SWORD,
        100000029,
    ...
    GatorItemData(
        ...
        ItemClassification.progression,
        1,
        [ItemGroup.Surface,ItemGroup.Shield, ItemGroup.Surface,ItemGroup.Item, ItemGroup.Surface,ItemGroup.Cardboard_Destroyer],
    ),
    GatorItemData(
    ...
    GatorItemData(
        ...
        ItemClassification.progression,
        1,
        [ItemGroup.Surface,ItemGroup.Traversal, ItemGroup.Surface,ItemGroup.Item, ItemGroup.Surface,ItemGroup.Cardboard_Destroyer],
    ),
    GatorItemData(
    ...
    GatorItemData(
        ...
        ItemClassification.filler,
        1,
        [ItemGroup.Surface,ItemGroup.Cardboard_Destroyer, ItemGroup.Surface,ItemGroup.Craft],
    ),
    GatorItemData(
        ...
        ItemClassification.useful,
        1,
        [ItemGroup.Surface,ItemGroup.Cardboard_Destroyer, ItemGroup.Surface,ItemGroup.Traversal, ItemGroup.Surface,ItemGroup.Item],
    ),
    GatorItemData(
        GatorItemName.ROCK,
        100000055,
        ItemClassification.progression,
        1,
        [ItemGroup.Surface,ItemGroup.Cardboard_Destroyer, ItemGroup.Surface,ItemGroup.Ranged, ItemGroup.Surface,ItemGroup.Item],
    ),
    GatorItemData(
    ...
    GatorItemData(
        ...
        ItemClassification.progression,
        1,
        [ItemGroup.Surface,ItemGroup.Cardboard_Destroyer, ItemGroup.Surface,ItemGroup.Item],
    ),
    GatorItemData(
    ...
    GatorItemData(
        GatorItemName.CAMERA, 100000062, ItemClassification.filler, 1, [ItemGroup.Surface,ItemGroup.Craft]
    ),
    GatorItemData(
    ...
    GatorItemData(
        GatorItemName.TEXTING, 100000064, ItemClassification.useful, 0, [ItemGroup.Surface,ItemGroup.Item]
    ),
    GatorItemData(
        GatorItemName.OAR,
        100000065,
    ...
    GatorItemData(
        ...
        0,
        [ItemGroup.Surface,ItemGroup.Trap],
    ),
    GatorItemData(
