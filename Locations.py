...
location_table: Dict[str, GatorLocationData] = {
    ...
    "Main Island - Sam (Pencil Jackal) Quest Completion": GatorLocationData("Game"),
    ...
    "Main Island - Joe (Pose Hawk) Quest Completion": GatorLocationData("Game"),
    ...
    "Main Island - Flint (BombBowl Mole) Quest Completion": GatorLocationData("Game"),
    ...
    "Main Island - Neil (Peptalk Rat) Quest Completion": GatorLocationData("Game"),
    "Main Island - Robin (Scared-to-Look Robin) Quest Completion": GatorLocationData("Game"),
    "Main Island - Penelope (Bastion Beaver) Quest Completion": GatorLocationData("Game"),
    ...
    "Main Island - Tanner (Pot Mimic Elk) Quest Completion": GatorLocationData("Game"),
